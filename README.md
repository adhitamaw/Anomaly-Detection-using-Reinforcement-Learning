...
> **Note:** Due to GitHub file size limitations, the dataset files (UNSW_NB15_training-set.csv and UNSW_NB15_testing-set.csv) are not included in this repository. Please download them from the [UNSW-NB15 official site](https://research.unsw.edu.au/projects/unsw-nb15-dataset) and place them in the `Dataset` folder.

## 💾 Model Files

Some large model files are not included in this repository due to GitHub size limitations:
- `Deep Q learning/deepnote_scheme_evaluation_results_20250513-052513.pkl` (155 MB)

If you need these model files, please contact me via email.
